...
export declare const ElementHelper: {
   ...
   */
  getAllElementsByPartialLinkText(
    text: any,
    parentEl?: TcElementImpl
  ): Promise<TcElementImpl[]>;
  /**
   ...
   */
  getAllElementsByPartialButtonText(
    text: any,
    parentEl?: TcElementImpl
  ): Promise<TcElementImpl[]>;
  /**
   ...
   */
  getAllElementsByCssContainingText(
    cssSelector: any,
    text: any,
    parentEl?: TcElementImpl
  ): Promise<TcElementImpl[]>;
